...
for (j in (1:40)){
	...
	for (i in 1:k){
		...
		Petitioner + Respondent + LowerCourt + Unconst, data = test, ntree=200, nodesize=j+10) # Complete this line!
		rf.prediction = predict(rf.model, newdata = test, type = "class") # Complete this line!
